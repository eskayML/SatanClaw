#!/usr/bin/env python3
"""
SQLite State Store for SatanClaw Agent.
...
DEFAULT_DB_PATH = get_satanclaw_home() / "state.db"
...
class SessionDB:
    ...
    # With multiple satanclaw processes (gateway + CLI sessions + worktree agents)
