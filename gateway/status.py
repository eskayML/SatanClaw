...
``~/.satan`` but can be overridden via the environment variable.  This means
...
def _get_lock_dir() -> Path:
    ...
    return state_home / "satan" / _LOCKS_DIRNAME
...
def _looks_like_gateway_process(pid: int) -> bool:
    """Return True when the live PID still looks like the Satan gateway."""
