"""
Email platform adapter for the SatanClaw gateway.

Allows users to interact with SatanClaw by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "SatanClaw Agent")
        ...
        msg_id = f"<satanclaw-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
