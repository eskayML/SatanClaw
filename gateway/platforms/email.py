"""
Email platform adapter for the Satan gateway.

Allows users to interact with Satan by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Satan Agent")
        ...
        msg_id = f"<satan-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
