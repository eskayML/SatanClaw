...
GATEWAY_SECRET_CAPTURE_UNSUPPORTED_MESSAGE = (
    ...
    "Load this skill in the local CLI to be prompted, or add the key to ~/.satan/.env manually."
)
...
IMAGE_CACHE_DIR = get_satan_dir("cache/images", "image_cache")
...
AUDIO_CACHE_DIR = get_satan_dir("cache/audio", "audio_cache")
...
DOCUMENT_CACHE_DIR = get_satan_dir("cache/documents", "document_cache")
