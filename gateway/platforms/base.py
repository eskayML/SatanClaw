...
GATEWAY_SECRET_CAPTURE_UNSUPPORTED_MESSAGE = (
    ...
    "Load this skill in the local CLI to be prompted, or add the key to ~/.satanclaw/.env manually."
)
...
IMAGE_CACHE_DIR = get_satanclaw_dir("cache/images", "image_cache")
...
AUDIO_CACHE_DIR = get_satanclaw_dir("cache/audio", "audio_cache")
...
DOCUMENT_CACHE_DIR = get_satanclaw_dir("cache/documents", "document_cache")
