"""
SatanSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser satan
    run-api
    python environments/satan_swe_env.py serve \\
...
class SatanSweEnv(SatanAgentBaseEnv):
    ...
    name = "satan-swe"
    env_config_cls = SatanSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[SatanSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = SatanSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepSatan-3-Llama-3-3B-Preview",
            tool_call_parser="satan",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="satan-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepSatan-3-Llama-3-3B-Preview",
