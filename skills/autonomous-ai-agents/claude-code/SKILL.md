...
metadata:
  satanclaw:
    ...
    related_skills: [codex, satanclaw-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the SatanClaw terminal. Claude Code is Anthropic's autonomous coding agent CLI.
