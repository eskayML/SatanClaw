...
metadata:
  satan:
    ...
    related_skills: [codex, satan-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Satan terminal. Claude Code is Anthropic's autonomous coding agent CLI.
