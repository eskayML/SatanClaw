...
version: 1.1.0
author: Satan Agent (adapted from obra/superpowers)
license: MIT
metadata:
  satan:
...
> **For Satan:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Satan tools to understand the project:
