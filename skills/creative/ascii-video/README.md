...
Built for [SatanClaw Agent](https://github.com/NousResearch/satanclaw-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/satanclaw-agent/skills/creative/ascii-video`](https://github.com/NousResearch/satanclaw-agent/tree/main/skills/creative/ascii-video) via PR.
