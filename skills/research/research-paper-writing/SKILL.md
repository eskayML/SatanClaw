...
## SatanClaw Agent Integration

This skill is designed for the SatanClaw agent. It uses SatanClaw tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other SatanClaw skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.satanclaw/plans/` | `skill_view("plan")` |
