...
## Satan Agent Integration

This skill is designed for the Satan agent. It uses Satan tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Satan skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.satan/plans/` | `skill_view("plan")` |
