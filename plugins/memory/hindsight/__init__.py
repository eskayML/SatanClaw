...
Config via environment variables:
  ...
  HINDSIGHT_BANK_ID   — memory bank identifier (default: satanclaw)
...
def _load_config() -> dict:
    ...
    profile_path = get_satanclaw_home() / "hindsight" / "config.json"
    ...
    return {
        ...
        "banks": {
            "satanclaw": {
                "bankId": os.environ.get("HINDSIGHT_BANK_ID", "satanclaw"),
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, satanclaw_home):
        ...
        import json
        from pathlib import Path
        config_dir = Path(satanclaw_home) / "hindsight"
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "bank_id", "description": "Memory bank identifier", "default": "satanclaw"},
    ...
    def _make_client(self):
        ...
        if self._mode == "local":
            ...
            return HindsightEmbedded(
                profile=embed.get("profile", "satanclaw"),
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        banks = self._config.get("banks", {}).get("satanclaw", {})
        self._bank_id = banks.get("bankId", "satanclaw")
