...
Config via environment variables:
  ...
  HINDSIGHT_BANK_ID   — memory bank identifier (default: satan)
...
def _load_config() -> dict:
    ...
    profile_path = get_satan_home() / "hindsight" / "config.json"
    ...
    return {
        ...
        "banks": {
            "satan": {
                "bankId": os.environ.get("HINDSIGHT_BANK_ID", "satan"),
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, satan_home):
        ...
        import json
        from pathlib import Path
        config_dir = Path(satan_home) / "hindsight"
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "bank_id", "description": "Memory bank identifier", "default": "satan"},
    ...
    def _make_client(self):
        ...
        if self._mode == "local":
            ...
            return HindsightEmbedded(
                profile=embed.get("profile", "satan"),
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        banks = self._config.get("banks", {}).get("satan", {})
        self._bank_id = banks.get("bankId", "satan")
