...
class TestParserRegistry:
    ...
    def test_satan_parser_registered(self):
        parsers = list_parsers()
        assert "satan" in parsers
...
class TestSatanParser:
    @pytest.fixture
    def parser(self):
        return get_parser("satan")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["satan"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use satan format since that's universal
