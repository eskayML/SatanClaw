...
class TestSetupProviderModelSelection:
    ...
    @patch("satan_cli.models.fetch_api_models", return_value=[])
    @patch("satan_cli.config.get_env_value", return_value="fake-key")
    def test_falls_back_to_default_models_without_crashing(
        ...
        from satan_cli.setup import _setup_provider_model_selection
        ...
        with patch("satan_cli.auth.PROVIDER_REGISTRY", mock_provider_registry):
    ...
    @patch("satan_cli.models.fetch_api_models")
    @patch("satan_cli.config.get_env_value", return_value="fake-key")
    ...
    def test_custom_model_selection(
        ...
        from satan_cli.setup import _setup_provider_model_selection, _DEFAULT_PROVIDER_MODELS
    ...
    @patch("satan_cli.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.7"])
    @patch("satan_cli.config.get_env_value", return_value="fake-key")
