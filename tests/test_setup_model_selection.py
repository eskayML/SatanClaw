...
class TestSetupProviderModelSelection:
    ...
    @patch("satanclaw_cli.models.fetch_api_models", return_value=[])
    @patch("satanclaw_cli.config.get_env_value", return_value="fake-key")
    def test_falls_back_to_default_models_without_crashing(
        ...
        from satanclaw_cli.setup import _setup_provider_model_selection
        ...
        with patch("satanclaw_cli.auth.PROVIDER_REGISTRY", mock_provider_registry):
    ...
    @patch("satanclaw_cli.models.fetch_api_models")
    @patch("satanclaw_cli.config.get_env_value", return_value="fake-key")
    ...
    def test_custom_model_selection(
        ...
        from satanclaw_cli.setup import _setup_provider_model_selection, _DEFAULT_PROVIDER_MODELS
    ...
    @patch("satanclaw_cli.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.7"])
    @patch("satanclaw_cli.config.get_env_value", return_value="fake-key")
