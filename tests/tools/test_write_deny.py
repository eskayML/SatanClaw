...
class TestWriteDenyExactPaths:
    ...
    def test_satanclaw_env(self):
        path = os.path.join(str(Path.home()), ".satanclaw", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_satanclaw_config_not_env(self):
        path = os.path.join(str(Path.home()), ".satanclaw", "config.yaml")
