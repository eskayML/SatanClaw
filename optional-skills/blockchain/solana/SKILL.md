...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by SatanClaw Agent
license: MIT
metadata:
  satanclaw:
...
Helper script path: ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.satanclaw/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
