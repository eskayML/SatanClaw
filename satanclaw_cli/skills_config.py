"""
Skills configuration for SatanClaw Agent.
`satanclaw skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.satanclaw/config.yaml under:
...
def skills_command(args=None):
    """Entry point for `satanclaw skills`."""
    from satanclaw_cli.curses_ui import curses_checklist
