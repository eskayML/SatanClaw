...
Usage:
    satanclaw pairing list              # Show all pending + approved users
    satanclaw pairing approve <platform> <code>  # Approve a pairing code
    satanclaw pairing revoke <platform> <user_id> # Revoke user access
    satanclaw pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle satanclaw pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: satanclaw pairing {list|approve|revoke|clear-pending}")
        print("Run 'satanclaw pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'satanclaw pairing list' to see pending codes.\n")
