...
# 5. Symlinks the 'satan' CLI command into ~/.local/bin
...
echo ""
echo -e "${CYAN}⚕ Satan Agent Setup${NC}"
echo ""
...
# ============================================================================
# PATH setup — symlink satan into ~/.local/bin
# ============================================================================

echo -e "${CYAN}→${NC} Setting up satan command..."

HERMES_BIN="$SCRIPT_DIR/venv/bin/satan"
mkdir -p "$HOME/.local/bin"
ln -sf "$HERMES_BIN" "$HOME/.local/bin/satan"
echo -e "${GREEN}✓${NC} Symlinked satan → ~/.local/bin/satan"
...
# ============================================================================
# Seed bundled skills into ~/.satan/skills/
# ============================================================================

HERMES_SKILLS_DIR="${HERMES_HOME:-$HOME/.satan}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.satan/skills/ ..."
...
echo ""
echo "Other commands:"
echo "  satan status        # Check configuration"
echo "  satan gateway install # Install gateway service (messaging + cron)"
echo "  satan cron list     # View scheduled jobs"
echo "  satan doctor        # Diagnose issues"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]] || [[ -z $REPLY ]]; then
    ...
    "$SCRIPT_DIR/venv/bin/python" -m satan_cli.main setup
fi
