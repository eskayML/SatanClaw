...
# 5. Symlinks the 'satanclaw' CLI command into ~/.local/bin
...
echo ""
echo -e "${CYAN}⚕ SatanClaw Agent Setup${NC}"
echo ""
...
# ============================================================================
# PATH setup — symlink satanclaw into ~/.local/bin
# ============================================================================

echo -e "${CYAN}→${NC} Setting up satanclaw command..."

HERMES_BIN="$SCRIPT_DIR/venv/bin/satanclaw"
mkdir -p "$HOME/.local/bin"
ln -sf "$HERMES_BIN" "$HOME/.local/bin/satanclaw"
echo -e "${GREEN}✓${NC} Symlinked satanclaw → ~/.local/bin/satanclaw"
...
# ============================================================================
# Seed bundled skills into ~/.satanclaw/skills/
# ============================================================================

HERMES_SKILLS_DIR="${HERMES_HOME:-$HOME/.satanclaw}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.satanclaw/skills/ ..."
...
echo "     satanclaw setup"
echo ""
echo "  3. Start chatting:"
echo "     satanclaw"
echo ""
echo "Other commands:"
echo "  satanclaw status        # Check configuration"
echo "  satanclaw gateway install # Install gateway service (messaging + cron)"
echo "  satanclaw cron list     # View scheduled jobs"
echo "  satanclaw doctor        # Diagnose issues"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]] || [[ -z $REPLY ]]; then
    ...
    "$SCRIPT_DIR/venv/bin/python" -m satanclaw_cli.main setup
fi
