...
into prompt_toolkit's event loop. Each function takes the SatanCLI instance
...
from satan_cli.banner import cprint, _DIM, _RST
from satan_cli.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.satan/.env and never exposed to the model.
    """
