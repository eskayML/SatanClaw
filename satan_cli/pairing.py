...
Usage:
    satan pairing list              # Show all pending + approved users
    satan pairing approve <platform> <code>  # Approve a pairing code
    satan pairing revoke <platform> <user_id> # Revoke user access
    satan pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle satan pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: satan pairing {list|approve|revoke|clear-pending}")
        print("Run 'satan pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'satan pairing list' to see pending codes.\n")
